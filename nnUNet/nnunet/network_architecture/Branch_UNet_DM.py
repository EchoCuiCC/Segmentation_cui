...
# Generic_Unet 通用Unet
class Branch_UNet_DM(SegmentationNetwork):
    ...
    def __init__(self, input_channels, base_num_features, num_classes, num_pool, num_conv_per_stage=2,
        ...
        """
        super(Branch_UNet_DM, self).__init__()
        ...
        for ds in range(len(self.conv_blocks_localization)):
            ...
            if centerline:
                self.centerline_outputs.append(conv_op(self.conv_blocks_localization[ds][-1].output_channels, 9,
                                            1, 1, 0, 1, 1, seg_output_use_bias))
