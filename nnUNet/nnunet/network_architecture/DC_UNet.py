...
# DC_UNet 通用Unet
class DC_UNet(SegmentationNetwork):
    ...
    def __init__(self, input_channels, base_num_features, num_classes, num_pool, num_conv_per_stage=2,
        ...
        for ds in range(len(self.conv_blocks_localization)):
            ...
            self.centerline_outputs.append(nn.Sequential(
                conv_op(self.conv_blocks_localization[ds][-1].output_channels, self.conv_blocks_localization[ds][-1].output_channels
                , 3, 1, 1, 1, 1, True),
                nonlin(**self.nonlin_kwargs),
                norm_op(self.conv_blocks_localization[ds][-1].output_channels,**self.norm_op_kwargs),
                conv_op(self.conv_blocks_localization[ds][-1].output_channels, num_classes
                , 1, 1, 0, 1, 1, seg_output_use_bias),
