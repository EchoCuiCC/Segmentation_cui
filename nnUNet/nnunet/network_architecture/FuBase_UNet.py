...
# Generic_Unet 通用Unet
class FuBase_UNet(SegmentationNetwork):
    ...
    def __init__(self, input_channels, base_num_features, num_classes, num_pool, num_conv_per_stage=2,
                 ...
                 seg_output_use_bias=False,centerline=False,branch_block_num=0,fusion_num=0,splitUp=False):
        """
        ...
        """
        super(FuBase_UNet, self).__init__()
        ...
        for u in range(len(self.tu)):
            ...
            if self.centerline and u>=self.num_pool-self.branch_block_num:
                ...
                if u>=self.num_pool-self.fusion_num:
                    ...
                    x = x+public_information
                    y = y+public_information
